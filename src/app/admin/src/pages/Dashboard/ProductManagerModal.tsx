...
import { CreateAppModal } from "@/app/admin/src/pages/AppManagement/components/CreateAppModal"
  ...
  const handleCreateApp = async (title: string) => {
    try {
      ...
      navigate(`/admin/apps/${appId}/builder`, {
        state: {
          initialPrompt: ProductAgent.formatRequirementForAppAgent(messages),
          messages: messages,
