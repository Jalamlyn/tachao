          ...
          <div className='flex items-start gap-4'>
            <div
              className={cn(
                ...
                isConfirmed ? "bg-blue-50 text-blue-600 ring-2 ring-blue-100" : "bg-gray-50 text-gray-400"
              )}
            >
              <Icon icon={isConfirmed ? "mdi:check-circle" : "mdi:clock-outline"} className='w-5 h-5' />
            </div>
