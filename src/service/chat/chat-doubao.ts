...
export default async function chatChunkDoubao(
  messages,
  onChunk,
  onCancel = () => {},
  isFirst = true,
  ...
  try {
    const response = await fetch("https://service-fpf07h2s-1259692580.usw.apigw.tencentcs.com/release/chat-doubao", {
      method: "POST",
      headers: {
