...
import { DataStructureTemplate, DataSourceInfo, PromptTemplate } from './types'
import { generateDataSourceInfo, generateDataStructureDescription, generateDataStatistics } from './generators'
...
export const templates: PromptTemplate = {
  ...
  data: {
    structure: (data: DataStructureTemplate) => generateDataStructureDescription(data),
    statistics: (data: DataStructureTemplate) => generateDataStatistics(data),
    source: (data: DataSourceInfo) => generateDataSourceInfo([data], {})
  },
  analysis: {
