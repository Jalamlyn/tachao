              ...
              {recentActivities.map((activity, index) => (
                ...
                >
                  <div className="relative">
                    ...
                    />
                    <div className={`absolute -bottom-1 -right-1 p-1 rounded-full bg-${activity.type === 'update' ? 'primary' : activity.type === 'create' ? 'success' : 'warning'}/10`}>
                      <Icon icon={getActivityIcon(activity.type)} className={`w-4 h-4 text-${activity.type === 'update' ? 'primary' : activity.type === 'create' ? 'success' : 'warning'}`} />
                    </div>
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      <Chip 
                        size="sm" 
                        variant="flat" 
                        color={activity.type === 'update' ? 'primary' : activity.type === 'create' ? 'success' : 'warning'}
                      >
                        {activity.type}
                      </Chip>
                    </div>
