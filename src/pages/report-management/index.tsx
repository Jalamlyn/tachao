...
const ResourceManagement: React.FC = () => {
  ...
  useEffect(() => {
    updateBreadcrumbs([
      ...
      { label: "报表管理", href: "/we-chat-app/admin/resources" },
    ])
  }, [])
  ...
  const columns = [
    {
      ...
      render: (record: Resource) => (
        <div className='flex items-center gap-2'>
          <Icon icon='mdi:file-chart' className='w-5 h-5 text-blue-500' style={{ opacity: 0.8 }} />
  ...
  const handleReportSelect = (reportId: string) => {
    navigate(`/we-chat-app/admin/resources/ai/${reportId}`)
  }
