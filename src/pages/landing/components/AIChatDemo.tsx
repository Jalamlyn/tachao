...
const demoMessages = [
  {
    ...
    response: {
      text: "正在为您设计智能库存管理系统...",
      features: ["• 实时库存监控仪表盘", "• 智能入库/出库管理", "• 库存预警自动提醒", "• 数据分析报表生成"],
      stats: {
        deployTime: "1分钟完成部署",
        efficiency: "效率提升75%",
        accuracy: "准确率99.9%",
  ...
  },
  {
    ...
    response: {
      text: "已为您生成库存概览：",
      data: ["• 总库存: 2,345件", "• 预警商品: 3件", "• 本周出库: 156件", "• 库存周转率: 76%"],
      chart: true,
    },
  },
  {
    ...
    response: {
      text: "正在生成智能分析报表...",
      insights: ["• 库存优化建议", "• 采购计划推荐", "• 销售趋势分析", "• 成本控制方案"],
    },
  },
]
  ...
  return (
    <div className='flex items-start gap-4'>
      ...
      <div className='flex-1'>
        <div
          className={`backdrop-blur-sm rounded-2xl p-4 inline-block max-w-[90%] border shadow-lg
    ...
    >
      ...
      >
        <div className='flex items-center gap-4'>
          <div
            className='flex-1 bg-white/5 rounded-xl backdrop-blur-sm border border-white/10 px-4 py-2
