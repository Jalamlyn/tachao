...
const features = [
  {
    ...
    details: ["AI辅助表单生成", "智能数据验证", "动态表单渲染", "多端自适应展示"],
  ...
  },
  {
    ...
    details: ["多维度数据分析", "AI辅助洞察", "实时数据监控", "智能决策支持"],
  ...
  },
  {
    ...
    details: ["智能任务分配", "实时进度追踪", "自动化工作流", "团队协作管理"],
  ...
  },
  {
    ...
    details: ["统一应用管理", "智能资源分配", "多维度权限控制", "资源智能分析"],
          ...
          {(onClose) => (
            <motion.div variants={modalVariants} initial='hidden' animate='visible' exit='exit'>
                            ...
                            <div key={idx} className='bg-white/10 rounded-lg p-4'>
                              ...
                              <div className='flex flex-wrap gap-2'>
                                {scenario.features.map((feature, fidx) => (
                                  <span key={fidx} className='text-xs bg-white/20 text-white px-2 py-1 rounded-full'>
                                    {feature}
                                  </span>
                                ))}
                              </div>
              ...
              <ModalFooter>
                ...
                <Button className='bg-white text-primary-dark' onPress={onClose}>
                  立即体验
                </Button>
              </ModalFooter>
            </motion.div>
